...
class RCWordCount{
    ...
    function rcScriptLoader(){
        //wp_die(dirname(plugin_basename(__FILE__)) . '/jt-word-count-plugin.js');
        wp_enqueue_script( 'wcp_wordcount-js', plugins_url( '/jt-word-count-plugin.js', __FILE__ ));
    ...
    {
        echo '<p id="footer-thankyou">Developed by <a href="https://www.pces.mk" target="_blank">Jovan Trajkov</a></p>';
