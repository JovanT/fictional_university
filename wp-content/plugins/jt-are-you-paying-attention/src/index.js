...
(function () {
    ...
    wp.data.subscribe(()=>{
        const results = wp.data.select("core/block-editor").getBlocks().filter((block)=>{
            return block.name == "jt-namespace/are-you-paying-attention" && block.attributes.correctAnswer == undefined;
        })
...
wp.blocks.registerBlockType('jt-namespace/are-you-paying-attention', {
